...
def main(config):
    ...
    for epoch in range(start_epoch, config.epochs + 1):
        ...
        if loss < min_loss:
            ...
            torch.save(model.module.state_dict(), os.path.join(checkpoint_dir, 'my_best.pth'))
            min_loss = loss
            min_epoch = epoch
        ...
        torch.save(model.module.state_dict(), os.path.join(checkpoint_dir, 'my_latest.pth'))
